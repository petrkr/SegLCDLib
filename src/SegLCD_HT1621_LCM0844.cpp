#if !defined(SEGLCD_DISABLE_ALL_LCDS) || defined(SEGLCD_ENABLE_HT1621_LCM0844)
#include <SegLCD_HT1621_LCM0844.h>


SegLCD_HT1621_LCM0844::SegLCD_HT1621_LCM0844(SegTransport3Wire& transport, uint8_t chipselect)
